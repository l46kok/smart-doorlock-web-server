...
namespace smart_doorlock_web_server
{
    ...
    public class MqttBroker
    {
        ...
        private static readonly MqttBroker _instance = new MqttBroker();
        public static MqttBroker Instance
        {
            get {
                return _instance;
            }
        ...
        void Client_MqttMsgPublishReceived(object sender, MqttMsgPublishEventArgs e)
        {
            ...
            Console.WriteLine("Publish Received: [{0},{1}]",e.Topic,e.Message);
        ...
        {
            MqttClient client = (MqttClient)sender;
            Console.WriteLine("Subscribe Received");
            for (int i = 0; i < e.Topics.Length; i++)
            {
                ...
                Console.WriteLine("Topic: " + e.Topics[i]);
            }
